				...
				<div className="grid-x grid-margin-x footer">
					<div className="cell small-12 medium-5 med-large-4 large-4 " id="address-container">
						<div className="grid-x grid-margin-x">
							...
							<p className="cell small-9 medium-8" style={{textAlign: "left"}}>PO BOX 12044<br />Everett, WA 98206</p>
						</div>
					</div>
					<div className="cell small-12 medium-6 med-large-6 large-5" id="contact-container">
						<div className="grid-x grid-margin-x">
							...
							<p className="cell small-9 medium-8" style={{textAlign: "left"}}><a href="mailto:huyenquangtran@gmail.com"><i className="fa fa-envelope"></i></a> huyenquangtran@gmail.com<br />
							<a href="tel:425-367-8790"><i className="fa fa-phone"></i></a> (425) 367-8790</p>
						</div>
					</div>
					...
					<div className="cell small-12" id="copyright-container">
						<p>Copyright © 2012-2016, Trường Việt Ngữ Lạc Hồng</p>
					</div>
				</div>
